  ...
  return (
    <Dialog open={isModalOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white text-black p-0 overflow-hidden">
        ...
        <div className="p-6">
          <Label className="supperca text-xs font-bold text-zinc-500 dark:text-secondary/70">
            Server invite link
          </Label>
          ...
          <Button variant="link" size='sm' disabled={isLoading} className="text-xs text-zinc-500 mt-4" onClick={onNew}>
            Generate a new link
            <RefreshCw className="w-4 h-4h ml-2" />
          </Button>
        </div>
      </DialogContent>
    </Dialog>
